        ...
        <div className="p-6 flex-1 overflow-y-auto">
          ...
          <div className="mb-10">
            <div className="flex justify-between items-center mb-4">
              ...
              <Link to="/events" className="bg-black text-yellow-400 px-4 py-2 rounded-full flex items-center hover:bg-gray-800 transition-colors">
                ...
                {events.slice(0, 3).map((event) => (
                  <div key={event.eventId} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <div className="p-4">
                      ...
                      <Link to={`/eventdetails/${event.eventId}`} className="block text-center bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-2 px-4 rounded transition-colors">
                        Learn More
                      </Link>
                    </div>
                  </div>
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <Link to="/merch" className="bg-black text-yellow-400 px-4 py-2 rounded-full flex items-center hover:bg-gray-800 transition-colors">
                View All <FaArrowRight className="ml-2" />
              </Link>
            </div>
                ...
                {merchandise.slice(0, 4).map((item) => (
                  <div key={item.id} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <div className="p-4">
                      ...
                      <Link to={`/merchdetails/${item.id}`} className="block text-center bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-2 px-4 rounded transition-colors">
                        View Details
                      </Link>
                    </div>
                  </div>
